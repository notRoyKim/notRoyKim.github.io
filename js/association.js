...
const tl = [{name: "브리흐네 잉어", qty: 10, class: "A", idx: "1"},
    {name: "개암버섯", qty: 50, class: "A", idx: "2"},
    {name: "힐웬 광석 조각", qty: 100, class: "A", idx: "3"},
    {name: "실리엔 결정", qty: 100, class: "A", idx: "4"},
    {name: "발화석", qty: 40, class: "A", idx: "5"},
    {name: "유황", qty: 60, class: "A", idx: "6"},
    {name: "철광석", qty: 60, class: "A", idx: "7"},
    {name: "동광석", qty: 20, class: "A", idx: "8"},
    {name: "은붕어", qty: 40, class: "B", idx: "9"},
    {name: "무른 힐웬 광석 조각", qty: 40, class: "B", idx: "10"},
    {name: "얼룩진 실리엔 결정", qty: 40, class: "B", idx: "11"},
    {name: "물이 든 병", qty: 15, class: "B", idx: "12"},
    {name: "우유", qty: 10, class: "B", idx: "13"},
    {name: "양털", qty: 100, class: "B", idx: "14"},
    {name: "동광석 조각", qty: 35, class: "B", idx: "15"},
    {name: "철광석 조각", qty: 80, class: "B", idx: "16"},
    {name: "감자", qty: 25, class: "C", idx: "17"},
    {name: "옥수수", qty: 25, class: "C", idx: "18"},
    {name: "밀", qty: 30, class: "C", idx: "19"},
    {name: "보리", qty: 30, class: "C", idx: "20"},
    {name: "나무장작", qty: 30, class: "C", idx: "21"},
    {name: "마나 허브", qty: 30, class: "C", idx: "22"},
    {name: "블러디 허브", qty: 30, class: "C", idx: "23"},
    {name: "베이스 허브", qty: 30, class: "C", idx: "24"}];

const pl = [{name: "숏보우", qty: 1, class: "A", idx: "25"},
    {name: "호미", qty: 1, class: "A", idx: "26"},
    {name: "폴라리스 결정", qty: 5, class: "A", idx: "27"},
    {name: "하다르 결정", qty: 5, class: "A", idx: "28"},
    {name: "철괴", qty: 50, class: "A", idx: "29"},
    {name: "동괴", qty: 50, class: "A", idx: "30"},
    {name: "스핀기어", qty: 10, class: "A", idx: "31"},
    {name: "뮤턴트", qty: 10, class: "A", idx: "32"},
    {name: "중급 나무장작", qty: 30, class: "B", idx: "33"},
    {name: "생명력 300 포션", qty: 30, class: "B", idx: "34"},
    {name: "마나 300 포션", qty: 30, class: "B", idx: "35"},
    {name: "고급 나무장작", qty: 20, class: "B", idx: "36"},
    {name: "스패너", qty: 1, class: "B", idx: "37"},
    {name: "스태미나 300 포션", qty: 30, class: "B", idx: "38"},
    {name: "신비한 허브 가루", qty: 20, class: "B", idx: "39"},
    {name: "코레스 힐러 글러브", qty: 1, class: "B", idx: "40"},
    {name: "힐웬", qty: 50, class: "C", idx: "41"},
    {name: "실리엔", qty: 50, class: "C", idx: "42"},
    {name: "일반 옷감", qty: 50, class: "C", idx: "43"},
    {name: "저가형 옷감", qty: 50, class: "C", idx: "44"},
    {name: "일반 실크", qty: 50, class: "C", idx: "45"},
    {name: "저가형 실크", qty: 50, class: "C", idx: "46"},
    {name: "일반 가죽끈", qty: 50, class: "C", idx: "47"},
    {name: "저가형 가죽끈", qty: 50, class: "C", idx: "48"}];
